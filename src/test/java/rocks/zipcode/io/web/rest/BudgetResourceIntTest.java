...
public class BudgetResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkExpectedTotalIsRequired() throws Exception {
        int databaseSizeBeforeTest = budgetRepository.findAll().size();
        // set the field null
        budget.setExpectedTotal(null);
    ...
    @Test
    @Transactional
    public void checkActualTotalIsRequired() throws Exception {
        int databaseSizeBeforeTest = budgetRepository.findAll().size();
        // set the field null
        budget.setActualTotal(null);

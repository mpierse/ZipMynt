...
describe('Bills e2e test', () => {
    ...
    it('should load Bills', async () => {
        ...
        expect(await billsComponentsPage.getTitle()).to.eq('Bills');
    });

    it('should load create Bills page', async () => {
        await billsComponentsPage.clickOnCreateButton();
        billsUpdatePage = new BillsUpdatePage();
        expect(await billsUpdatePage.getPageTitle()).to.eq('Create or edit a Bills');
    ...
    it('should delete last Bills', async () => {
        ...
        expect(await billsDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Bills?');

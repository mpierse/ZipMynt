...
describe('BillItem e2e test', () => {
    ...
    it('should load BillItems', async () => {
        ...
        expect(await billItemComponentsPage.getTitle()).to.eq('Bill Items');
    });
    ...
    it('should load create BillItem page', async () => {
        ...
        expect(await billItemUpdatePage.getPageTitle()).to.eq('Create or edit a Bill Item');
    ...
    it('should delete last BillItem', async () => {
        ...
        expect(await billItemDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Bill Item?');

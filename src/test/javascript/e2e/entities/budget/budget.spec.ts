...
describe('Budget e2e test', () => {
    ...
    it('should load Budgets', async () => {
        ...
        expect(await budgetComponentsPage.getTitle()).to.eq('Budgets');
    });
    ...
    it('should load create Budget page', async () => {
        ...
        expect(await budgetUpdatePage.getPageTitle()).to.eq('Create or edit a Budget');
    ...
    it('should delete last Budget', async () => {
        ...
        expect(await budgetDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Budget?');

...
public class MoneyAccountResource {
    ...
    @Timed
    public ResponseEntity<MoneyAccount> createMoneyAccount(@Valid @RequestBody MoneyAccount moneyAccount) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<MoneyAccount> updateMoneyAccount(@Valid @RequestBody MoneyAccount moneyAccount) throws URISyntaxException {

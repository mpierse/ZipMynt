...
public class BillsResource {
    ...
    @PostMapping("/bills")
    @Timed
    public ResponseEntity<Bills> createBills(@Valid @RequestBody Bills bills) throws URISyntaxException {
    ...
    @PutMapping("/bills")
    @Timed
    public ResponseEntity<Bills> updateBills(@Valid @RequestBody Bills bills) throws URISyntaxException {
